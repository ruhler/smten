...
y1ctx (*y1_mk_context_f)(void) = NULL;
y1ctx (*y1_del_context_f)(y1ctx) = NULL;
...
char* (*y1_get_last_error_message_f)(void) = NULL;
y1bool (*y1_get_value_f)(y1model, y1decl) = NULL;
int (*y1_get_int_value_f)(y1model, y1decl, long*) = NULL;
int (*y1_get_bitvector_value_f)(y1model, y1decl, unsigned int, int*) = NULL;
...
y1expr (*y1_mk_and_f)(y1ctx, y1expr*, unsigned int) = NULL;
y1expr (*y1_mk_sum_f)(y1ctx, y1expr*, unsigned int) = NULL;
y1expr (*y1_mk_sub_f)(y1ctx, y1expr*, unsigned int) = NULL;
...
y1expr (*y1_mk_bv_sign_extend_f)(y1ctx, y1expr, unsigned int) = NULL;
y1expr (*y1_mk_bv_extract_f)(y1ctx, unsigned int, unsigned int, y1expr) = NULL;
y1expr (*y1_mk_bv_le_f)(y1ctx, y1expr, y1expr) = NULL;
y1expr (*y1_mk_num_f)(y1ctx, int) = NULL;
y1expr (*y1_mk_bv_constant_f)(y1ctx, unsigned int, unsigned long) = NULL;
y1expr (*y1_mk_bv_constant_from_array_f)(y1ctx, unsigned, int*) = NULL;
y1expr (*y1_mk_bv_shift_left0_f)(y1ctx, y1expr, unsigned int) = NULL;
y1expr (*y1_mk_bv_shift_right0_f)(y1ctx, y1expr, unsigned int) = NULL;
...
y1ctx y1_mk_context(void) { return  y1_mk_context_f(); }
y1ctx y1_del_context(y1ctx a) { return  y1_del_context_f(a); }
...
char* y1_get_last_error_message(void) { return  y1_get_last_error_message_f(); }
...
int y1_get_bitvector_value(y1model a, y1decl b, unsigned int c, int* d) { return  y1_get_bitvector_value_f(a, b, c, d); }
...
y1expr y1_mk_and(y1ctx a, y1expr* b, unsigned int c) { return  y1_mk_and_f(a, b, c); }
y1expr y1_mk_sum(y1ctx a, y1expr* b, unsigned int c) { return  y1_mk_sum_f(a, b, c); }
y1expr y1_mk_sub(y1ctx a, y1expr* b, unsigned int c) { return  y1_mk_sub_f(a, b, c); }
...
y1expr y1_mk_bv_sign_extend(y1ctx a, y1expr b, unsigned int c) { return  y1_mk_bv_sign_extend_f(a, b, c); }
y1expr y1_mk_bv_extract(y1ctx a, unsigned int b, unsigned int c, y1expr d) { return  y1_mk_bv_extract_f(a, b, c, d); }
...
y1expr y1_mk_bv_constant(y1ctx a, unsigned int b, unsigned long c) { return  y1_mk_bv_constant_f(a, b, c); }
y1expr y1_mk_bv_constant_from_array(y1ctx a, unsigned b, int* c) { return y1_mk_bv_constant_from_array_f(a, b, c); }
y1expr y1_mk_bv_shift_left0(y1ctx a, y1expr b, unsigned int c) { return  y1_mk_bv_shift_left0_f(a, b, c); }
y1expr y1_mk_bv_shift_right0(y1ctx a, y1expr b, unsigned int c) { return  y1_mk_bv_shift_right0_f(a, b, c); }
