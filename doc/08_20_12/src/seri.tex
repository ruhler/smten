...
\onslide<2> \includegraphics[width=\textwidth]{input2}
\end{overprint}
\end{frame}

\begin{frame}{How to Implement a Sudoku Solver}
\begin{overprint}
\onslide<1> \includegraphics[width=\textwidth]{current1}
\onslide<2> \includegraphics[width=\textwidth]{current2}
\onslide<3> \includegraphics[width=\textwidth]{current3}
\onslide<4> \includegraphics[width=\textwidth]{current4}
\onslide<5> \includegraphics[width=\textwidth]{current5}
\onslide<6> \includegraphics[width=\textwidth]{current6}
\onslide<7> \includegraphics[width=\textwidth]{current7}
\onslide<8> \includegraphics[width=\textwidth]{current8}
\end{overprint}
\end{frame}
...
\onslide<2> \includegraphics[width=\textwidth]{isvalid2}
...
\onslide<3> \includegraphics[width=0.7\textwidth]{bitcell3}
