...
indir build/smten-base {
    hrun ghc -O1 --make -osuf smten_o -c -fplugin=Smten.Plugin.Plugin Smten/Prelude.hs
...
indir build/smten-lib {
    hrun ghc -O1 --make -osuf smten_o -c -main-is Smten.Tests.All.main \
        -fplugin=Smten.Plugin.Plugin Smten/Tests/All.hs
    hrun ghc -O1 --make -osuf smten_o -c -main-is Smten.Tests.SMT.Memory.Pure.main \
...
indir build/smten-yices2 {
    hrun ghc -O1 --make -c -osuf smten_o -main-is Smten.Tests.Yices2.main \
        -fplugin=Smten.Plugin.Plugin Smten/Tests/Yices2.hs
    hrun ghc -O1 --make -osuf smten_o -c -main-is Smten.Tests.SMT.Memory.Yices2.main \
...
indir build/smten-yices1 {
    hrun ghc -O1 --make -c -osuf smten_o -main-is Smten.Tests.Yices1.main \
        -fplugin=Smten.Plugin.Plugin Smten/Tests/Yices1.hs
    hrun ghc -O1 --make -osuf smten_o -c -main-is Smten.Tests.SMT.Memory.Yices1.main \
...
indir build/smten-stp {
    hrun ghc -O1 --make -c -osuf smten_o -main-is Smten.Tests.STP.main \
        -fplugin=Smten.Plugin.Plugin Smten/Tests/STP.hs
    hrun ghc -O1 --make -osuf smten_o -c -main-is Smten.Tests.SMT.Memory.STP.main \
