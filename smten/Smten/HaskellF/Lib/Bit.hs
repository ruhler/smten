...
__prim_eq_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) Bool)
__prim_eq_Bit = primHF eq_BitP

__prim_show_Bit :: (HaskellF n) => Function (Bit n) String
__prim_show_Bit = primHF show_BitP

__prim_add_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) (Bit n))
__prim_add_Bit = primHF add_BitP

__prim_sub_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) (Bit n))
__prim_sub_Bit = primHF sub_BitP

__prim_mul_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) (Bit n))
__prim_mul_Bit = primHF mul_BitP

__prim_fromInteger_Bit :: (HaskellF n) => Function Integer (Bit n)
__prim_fromInteger_Bit = primHF fromInteger_BitP

__prim_toInteger_Bit :: (HaskellF n) => Function (Bit n) Integer
__prim_toInteger_Bit = primHF toInteger_BitP

__prim_shl_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) (Bit n))
__prim_shl_Bit = primHF shl_BitP

__prim_lshr_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) (Bit n))
__prim_lshr_Bit = primHF lshr_BitP

__prim_or_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) (Bit n))
__prim_or_Bit = primHF or_BitP

__prim_and_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) (Bit n))
__prim_and_Bit = primHF and_BitP

__prim_not_Bit :: (HaskellF n) => Function (Bit n) (Bit n)
__prim_not_Bit = primHF not_BitP

__prim_zeroExtend_Bit :: (HaskellF n, HaskellF m) => Function (Bit n) (Bit m)
__prim_zeroExtend_Bit = primHF zeroExtend_BitP

__prim_signExtend_Bit :: (HaskellF n, HaskellF m) => Function (Bit n) (Bit m)
__prim_signExtend_Bit = primHF signExtend_BitP

__prim_concat_Bit :: (HaskellF n, HaskellF m, HaskellF n_plus_m)
                     => Function (Bit n) (Function (Bit m) (Bit n_plus_m))
__prim_concat_Bit = primHF concat_BitP

__prim_extract_Bit :: (HaskellF n, HaskellF m) => Function (Bit n) (Function Integer (Bit m))
__prim_extract_Bit = primHF extract_BitP

__prim_lt_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) Bool)
__prim_lt_Bit = primHF lt_BitP

__prim_leq_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) Bool)
__prim_leq_Bit = primHF leq_BitP

__prim_gt_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) Bool)
__prim_gt_Bit = primHF gt_BitP

__prim_geq_Bit :: (HaskellF n) => Function (Bit n) (Function (Bit n) Bool)
